...
public class PartitaDiCalcio extends Evento implements Serializable{
	...
	private static final boolean[] obbligatoriet‡ = {true,true};
	private static final String[] descrizioni = {
			"Genere dei partecipanti",
			"Limiti di et‡ dei partecipanti"
			};
	...
	public static boolean[] getObbligatoriet‡() {
